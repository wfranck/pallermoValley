...
function k2menu() {
//	add_submenu_page('themes.php', 'Options', 'Options', 5, $k2loc . 'functions.php', 'menu');
}
...
<?php if (isset($_POST['Submit'])) : ?>
	<div class="updated">
		<p><?php _e('Options have been updated'); ?></p>
	</div>
<?php endif; ?>
	  ...
	  <input type="hidden" name="page_options" value="'dofollow_timeout'" />
		<table width="700px" cellspacing="2" cellpadding="5" class="editform">
			...
			<td>
				...
				<label for="add-archives"><?php _e('Enable the Archives page') ?></label>
